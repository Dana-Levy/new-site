            ...
            <div className={styles.root}>
                ...
                <div className={styles.content}>
                    ...
                    <p className={styles.description}>
                        ...
                        processes of harvesting, roasting, and brewing that create the diverse
                        flavors and aromas in every cup. Perfect for both casual drinkers and coffee
                        enthusiasts.
                    </p>
                    <p className={styles.numbers}>677 saves</p>
                </div>
            </div>
        </div>
    );
